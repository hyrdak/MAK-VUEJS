          ...
          <!--Grid column-->
              <div class="col-lg-3 col-md-4 mb-3 text-left">
                  ...
                  <div class="view overlay z-depth-1-half">
                      <img src="Content\imgCOFFEE\" width="250px" class="img-fluid" alt="">
                      <div class="mask rgba-white-slight"></div>
              </div>
          <h5 class="my-4 font-weight-bold" style="color: red;"><sup><u>d</u></sup></br>
          </h5>
          <a href="">
              <span></span></br></a>
...
<!--Grid row-->
  ...
  <div class="col-lg-3 col-md-4 mb-3 text-left">
      ...
      <h5 class="my-4 font-weight-bold">
          <font color="red"><sup><u></u></sup></font>
          <strike></strike><sup><u>d</u></sup>
      </h5>
